const { PollTwoTone } = require("@mui/icons-material");
...
function focusPlusContext(data) {
   ...
   maxDate_plus = new Date(maxDate.getTime() + 300 * 144000000); 
     ...
     */
    // domain sets the min- and max-value of the scale
    ...
    */
    ...
    small_points = dots.selectAll("dot")
      ...
      */
     //plot finns i plot_points.js, där finns en class som heter points 
     //(small_points, size of the gray points, size of the orange/red points)
