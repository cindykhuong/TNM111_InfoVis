...
function worldMap(data) {
    ...
    */
    L.tileLayer(map_link()).addTo(leaflet_map); //create empty map
    ...
    function projectPointsOnMap(x, y) {
        var point = leaflet_map.latLngToLayerPoint(new L.LatLng(y,x)); //LatLng (latitude, longitude)
    ...
    var feature = g.selectAll("circle")
        ...
        .style("opacity", 0.5); //set opacity for the map
